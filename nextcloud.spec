...
BuildRequires: (php-composer(doctrine/dbal) >= 2.5.9 with php-composer(doctrine/dbal) < 2.6)
Requires:      (php-composer(doctrine/dbal) >= 2.5.9 with php-composer(doctrine/dbal) < 2.6)
...
# TODO: NC13: 1.0.0
BuildRequires: (php-composer(icewind/searchdav) >= 0.3.1 with php-composer(icewind/searchdav) < 1.0.0)
Requires:      (php-composer(icewind/searchdav) >= 0.3.1 with php-composer(icewind/searchdav) < 1.0.0)
# "icewind/Streams": "0.5.2"
BuildRequires: (php-composer(icewind/streams) >= 0.5.2 with php-composer(icewind/streams) < 1.0)
Requires:      (php-composer(icewind/streams) >= 0.5.2 with php-composer(icewind/streams) < 1.0)
...
# "leafo/scssphp": "^0.6.6"
# TODO: NC13: ^0.7.2.
BuildRequires: (php-composer(leafo/scssphp) >= 0.6.6 with php-composer(leafo/scssphp) < 1.0.0)
Requires:      (php-composer(leafo/scssphp) >= 0.6.6 with php-composer(leafo/scssphp) < 1.0.0)
...
BuildRequires: (php-composer(lukasreschke/id3parser) >= 0.0.1 with php-composer(lukasreschke/id3parser) < 1.0.0)
Requires:      (php-composer(lukasreschke/id3parser) >= 0.0.1 with php-composer(lukasreschke/id3parser) < 1.0.0)
...
%if 0%{?el7}
BuildRequires: (php-pear(Archive_Tar) >= 1.3 with php-pear(Archive_Tar) < 2.0)
Requires:      (php-pear(Archive_Tar) >= 1.3 with php-pear(Archive_Tar) < 2.0)
%else
...
# "pimple/pimple": "3.0.2"
# TODO: NC13: 3.2.3
BuildRequires: (php-composer(pimple/pimple) >= 3.0.2 with php-composer(pimple/pimple) < 4.0)
Requires:      (php-composer(pimple/pimple) >= 3.0.2 with php-composer(pimple/pimple) < 4.0)
# "punic/punic": "^1.6"
...
BuildRequires: (php-composer(stecman/symfony-console-completion) >= 0.7.0 with php-composer(stecman/symfony-console-completion) < 1.0.0)
Requires:      (php-composer(stecman/symfony-console-completion) >= 0.7.0 with php-composer(stecman/symfony-console-completion) < 1.0.0)
...
# TODO: NC13 ^3.3.0
BuildRequires: (php-composer(symfony/console) >= 3.0.0 with php-composer(symfony/console) < 4)
Requires:      (php-composer(symfony/console) >= 3.0.0 with php-composer(symfony/console) < 4)
# "symfony/event-dispatcher": "^3.0.0"
# TODO: NC13 ^3.3.0
BuildRequires: (php-composer(symfony/event-dispatcher) >= 3.0.0 with php-composer(symfony/event-dispatcher) < 4)
Requires:      (php-composer(symfony/event-dispatcher) >= 3.0.0 with php-composer(symfony/event-dispatcher) < 4)
...
# TODO: NC13 ^3.3.0
BuildRequires: (php-composer(symfony/process) >= 3.0.0 with php-composer(symfony/process) < 4)
Requires:      (php-composer(symfony/process) >= 3.0.0 with php-composer(symfony/process) < 4)
# "symfony/routing": "^3.0.0"
# TODO: NC13 ^3.3.0
BuildRequires: (php-composer(symfony/routing) >= 3.0.0 with php-composer(symfony/routing) < 4)
Requires:      (php-composer(symfony/routing) >= 3.0.0 with php-composer(symfony/routing) < 4)
...
# NOTE: google/apiclient and dropbox are not in composer.json
BuildRequires:  php-composer(google/apiclient)
Requires:       php-composer(google/apiclient)
BuildRequires:  php-pear(pear.dropbox-php.com/Dropbox)
Requires:       php-pear(pear.dropbox-php.com/Dropbox)
#"icewind/smb": "2.0.0"
# TODO: NC13  2.0.4
BuildRequires: (php-composer(icewind/smb) >= 2.0.0 with php-composer(icewind/smb) < 3.0)
Requires:      (php-composer(icewind/smb) >= 2.0.0 with php-composer(icewind/smb) < 3.0)
...
# "symfony/yaml": "~3.2"
BuildRequires: (php-composer(symfony/yaml) >= 3.0.0 with php-composer(symfony/yaml) < 4)
Requires:      (php-composer(symfony/yaml) >= 3.0.0 with php-composer(symfony/yaml) < 4)
...
# TODO: NC13 revisit versions, add link to bower.json
...
# TODO: NC13 revisit, add link to bower.json
...
# clean up composer, extraneous files and any empty directories
rm -r composer*
...
%changelog
* Wed Feb 7 2018 Christian Glombek <christian.glombekg@rwth-aachen.de> - 12.0.5-1
- Update to 12.0.5
